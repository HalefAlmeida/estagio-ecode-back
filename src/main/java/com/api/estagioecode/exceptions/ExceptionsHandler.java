...
@ControllerAdvice //Diz ao spring que quando um problema ocorrer, é esta classe que deve ser chamada
public class ExceptionsHandler extends ResponseEntityExceptionHandler { //Extende o tipo de response a ser verificado
